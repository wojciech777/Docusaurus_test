...
The window is configured by the `ORION_ORDER_EXPIRY_MINUTES` parameter at the tenant level, in the range of 5 to 1440 minutes. A change applies only to orders submitted after it was introduced. See [environment variables](../../../getting-started/configuration/environment-variables.mdx).
:::
...
- [Event types](../../webhooks/event-types.mdx)
