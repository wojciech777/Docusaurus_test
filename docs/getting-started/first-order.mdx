...
Verify the signature before you process the body, the procedure is described in [Signature verification](../api/webhooks/signature-verification.mdx).
...
- [Order resources](../api/rest/resources/orders.mdx): the full resource contract and all status transitions.
- [Payment resources](../api/rest/resources/payments.mdx): partial captures, refunds and settlements.
- [Event types](../api/webhooks/event-types.mdx): the schemas of the ten domain events.
- [Authentication with API keys](../guides/authentication/api-keys.mdx): an alternative to OAuth2.
- [Java SDK](../api/sdk/java.mdx) and [Python SDK](../api/sdk/python.mdx): client libraries with retry and idempotency support.
...
- [OAuth2](../guides/authentication/oauth2.mdx)
- [Rate limits](../api/rest/rate-limits.mdx)
