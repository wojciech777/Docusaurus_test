...
```json title="200 OK response, first page" {16,17}
{
  "data": [
    {
...
The offset endpoints were retired together with version 3.8 and are not available under `/v1`. Full procedure: [migration from 3.8 to 4.2](../../guides/migrations/from-3-8-to-4-2.mdx).
