...
Returns a list of customers in descending order by `created_at`. Cursor pagination is described in [Pagination](../pagination.mdx).
...
<details>
<summary>Complete 200 OK response</summary>
