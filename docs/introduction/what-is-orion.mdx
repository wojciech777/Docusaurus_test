...
After 2026-03-31 the 3.8 line will receive no fixes at all, including critical ones. Plan the upgrade according to [Migration from 3.8 to 4.2](../guides/migrations/from-3-8-to-4-2.mdx).
:::

<details>
<summary>Patch release numbering</summary>
