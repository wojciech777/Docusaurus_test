...
<mark>at-least-once</mark>. The same event may be delivered more than once, for example after
...
| Page | Contents |
| --- | --- |
| [Queues and topics](queues.mdx) | topic configuration, consumer groups, DLQ, retention |
| [Retries and idempotency](retries.mdx) | retry policy, idempotency keys, circuit breaker |

## See also

- [Event types](../../api/webhooks/event-types.mdx)
- [Signature verification](../../api/webhooks/signature-verification.mdx)
