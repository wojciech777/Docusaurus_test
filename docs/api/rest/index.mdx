...
Full description: [OAuth2](../../guides/authentication/oauth2.mdx) and [API keys](../../guides/authentication/api-keys.mdx).
...
This identifier is the only key by which support can find your request in the logs. See [Logs](../../operations/monitoring/logs.mdx).
:::
...
```json title="PATCH /v1/customers/cus_01HQ8ZV3KXN4M2T9YB7C6D request" {2,4}
{
  "phone": null,
  "metadata": {
    "segment": "b2b"
...
- [Pagination, filtering, and sorting](pagination.mdx)
- [Orders](resources/orders.mdx)
