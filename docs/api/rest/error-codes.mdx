...
Record the identifier for every failed response. Searching by `request_id` is described on the [Logs](../../operations/monitoring/logs.mdx) page. A report without an identifier extends diagnosis by at least one iteration.

## Examples of complete responses

<details>
<summary>Validation error, 400 ORN-1007</summary>
...
<details>
<summary>Rate limit exceeded, 429 ORN-3001</summary>
...
<details>
<summary>State conflict, 409 ORN-4005</summary>
