...
- `ORION_ENCRYPTION_KEY` is immutable for the lifetime of the installation. Rotation requires the re-encryption procedure described in [Security](../../operations/security.mdx).
...
- [Install with Docker](../installation/docker.mdx)
