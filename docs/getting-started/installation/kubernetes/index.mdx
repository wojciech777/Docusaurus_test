...
| Feature | [Helm](helm.mdx) | [Operator](operator.mdx) |
| --- | --- | --- |
...
If you run one or two instances and already have Helm-based processes, choose [Helm](helm.mdx). If you manage many instances for different tenants and expect automatic migrations and backups, choose the [operator](operator.mdx).
:::
