...
```json title="Complete event envelope" {2,6,7}
{
...
<details>
<summary>customer.updated</summary>
...
The step-by-step mapping together with a migration checklist is described in [Migrate from 3.8 LTS to 4.2 LTS](../../guides/migrations/from-3-8-to-4-2.mdx).[^1]
